...
export class Board {
    ...
    */
    raw() {
        try {
            ...
            wasm.board_raw(retptr, this.ptr);
    ...
    */
    string() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.board_string(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
    ...
    */
    place(piece, row) {
        wasm.board_place(this.ptr, piece, row);
    }
    /**
    * @returns {number}
    */
    is_won() {
        var ret = wasm.board_is_won(this.ptr);
        return ret;
    }
    /**
    * @returns {Uint32Array}
    */
    free_columns() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.board_free_columns(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
...
export class Evaluation {
    ...
    static __wrap(ptr) {
        const obj = Object.create(Evaluation.prototype);
        obj.ptr = ptr;
    ...
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_evaluation_free(ptr);
    }
    /**
    * @returns {number}
    */
    get piece() {
        var ret = wasm.__wbg_get_evaluation_piece(this.ptr);
        return ret;
    }
    /**
    * @param {number} arg0
    */
    set piece(arg0) {
        wasm.__wbg_set_evaluation_piece(this.ptr, arg0);
    }
    /**
    * @returns {number}
    */
    get slot() {
        var ret = wasm.__wbg_get_evaluation_slot(this.ptr);
        return ret >>> 0;
    }
    /**
    * @param {number} arg0
    */
    set slot(arg0) {
        wasm.__wbg_set_evaluation_slot(this.ptr, arg0);
    }
    /**
    * @returns {number}
    */
    get wins() {
        var ret = wasm.__wbg_get_evaluation_wins(this.ptr);
        return ret;
    }
    /**
    * @param {number} arg0
    */
    set wins(arg0) {
        wasm.__wbg_set_evaluation_wins(this.ptr, arg0);
    }
    /**
    * @returns {number}
    */
    get losses() {
        var ret = wasm.__wbg_get_evaluation_losses(this.ptr);
        return ret;
    }
    /**
    * @param {number} arg0
    */
    set losses(arg0) {
        wasm.__wbg_set_evaluation_losses(this.ptr, arg0);
    }
    /**
    * @returns {number}
    */
    get ties() {
        var ret = wasm.__wbg_get_evaluation_ties(this.ptr);
        return ret;
    }
    /**
    * @param {number} arg0
    */
    set ties(arg0) {
        wasm.__wbg_set_evaluation_ties(this.ptr, arg0);
    }
    /**
    * @returns {number}
    */
    score() {
        var ret = wasm.evaluation_score(this.ptr);
        return ret;
    }
    /**
    * @returns {Evaluation}
    */
    flip() {
        var ret = wasm.evaluation_flip(this.ptr);
        return Evaluation.__wrap(ret);
    }
    /**
    * @param {Evaluation} other
    */
    add(other) {
        _assertClass(other, Evaluation);
        wasm.evaluation_add(this.ptr, other.ptr);
    }
    /**
    * @param {number} piece
    * @param {number} slot
    ...
    * @param {number} ties
    */
    constructor(piece, slot, wins, losses, ties) {
        var ret = wasm.evaluation_new(piece, slot, wins, losses, ties);
        return Evaluation.__wrap(ret);
    }
}
/**
...
export class Evaluator {
    ...
    */
    get_move(b, piece) {
        _assertClass(b, Board);
        var ret = wasm.evaluator_get_move(this.ptr, b.ptr, piece);
        return Evaluation.__wrap(ret);
    }
}
...
async function init(input) {
    ...
    const imports = {};
    imports.wbg = {};
    imports.wbg.__wbg_setTimeout_f4346870132c93f5 = typeof setTimeout == 'function' ? setTimeout : notDefined('setTimeout');
